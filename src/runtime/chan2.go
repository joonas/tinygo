...
// skipped.
// This function must be called with the channel lock held.
func (q *chanQueue) pop(chanOp uint64) *channelBlockedList {
	for {
		if q.first == nil {
			return nil
		}
		...
		swapped := atomic.CompareAndSwapUint64(&popped.task.Data, 0, newDataValue)
		if swapped {
			return popped
		}
	}
...
var chanSelectLock task.AsyncLock
